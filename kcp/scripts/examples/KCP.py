...
class MoveGroupPythonInterface(object):    
    ...
    def add_table_fun(self):        
        ...
        box_name = "table"
        scene.add_box(box_name, box_pose, size=(0.75, 1, 0.05))        
...
def main():    
    ...
    try:
        ...
        add_table_button.grid(row=0,column=1, columnspan=1, padx=padx_value, pady=pady_value)

        del_table_button = tkinter.Button(ventana, text= "Del. Table", command=lambda: windows_events("del_table"))
        del_table_button.grid(row=0,column=2, columnspan=1, padx=padx_value, pady=pady_value)
